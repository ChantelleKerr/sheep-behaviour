...
class Test_processdata(unittest.TestCase):
    def test_ProcessData(self):
        ...
        # Create test data set storage path
        ...
        try:
            ...
            print("Function start_read_data(), no problem.")
        except AssertionError:
            print("There is a problem with the function start_read_data().")
        ...
        if os.path.exists("test.csv"):
            ...
            try:
                pd.testing.assert_frame_equal(cleaned_df, saved_test_df)
                print("Function start_save_to_csv(), no problem.")
            except AssertionError:
                print("There is a problem with the function start_save_to_csv(), and the saved data is incorrect.")
        else:
            print("There is a problem with the function start_save_to_csv(), the csv file is not saved.")
